...
class AntraService:
    ...
    def fetch_playlist_tracks(
        ...
        # Handle TIDAL / Qobuz / Deezer metadata URLs
            ...
            if is_tidal_url(playlist):
                ...
                self._apply_source_intent(tracks, service="tidal", rule="prefer_hires")
                ...
                self._apply_source_intent(tracks, service="deezer", rule="prefer_hires")
    ...
    _METADATA_PROXY_KEY = os.getenv("ANTRA_METADATA_KEY", "")
